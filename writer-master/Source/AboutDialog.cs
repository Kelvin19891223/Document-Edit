namespace Writer
{
    ...
    internal class AboutDialog : Dialog
    {
        public AboutDialog()
        {
            ...
            applicationLabel.Text = (this.GetType().Assembly.GetCustomAttributes(typeof(AssemblyTitleAttribute), false)[0] as AssemblyTitleAttribute).Title + " " + GetType().Assembly.GetName().Version;
